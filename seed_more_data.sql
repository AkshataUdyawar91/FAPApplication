-- Seed 4 new PendingASM submissions with full data (PO, Invoice, Teams, ValidationResults, ConfidenceScores)
...
BEGIN
    INSERT INTO DocumentPackages (Id, AgencyId, State, ActivityState, SubmissionNumber, AssignedCircleHeadUserId, CurrentStep, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@Pkg1, 'A1000001-0000-0000-0000-000000000001', 4, N'Bihar', N'FAP-2025-0101', @AsmUserId, 0, DATEADD(HOUR,-3,@Now), @Now, 0);

    INSERT INTO POs (Id, PackageId, PONumber, TotalAmount, RemainingBalance, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@PO1, @Pkg1, N'PO-BH-2025-4401', 800000.00, 356279.00, N'PO-BH-4401.pdf', N'https://blob/po1.pdf', 245000, N'application/pdf', DATEADD(HOUR,-3,@Now), @Now, 0);
    ...
    INSERT INTO CostSummaries (Id, PackageId, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@CS1, @Pkg1, N'CostSummary-BH-01.pdf', N'https://blob/cs1.pdf', 120000, N'application/pdf', DATEADD(HOUR,-3,@Now), @Now, 0);

    INSERT INTO ActivitySummaries (Id, PackageId, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@AS1, @Pkg1, N'Activity-BH-01.pdf', N'https://blob/as1.pdf', 95000, N'application/pdf', DATEADD(HOUR,-3,@Now), @Now, 0);

    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, IsValid, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    ...
    INSERT INTO ConfidenceScores (Id, PackageId, OverallScore, PoScore, InvoiceScore, CostSummaryScore, ActivityScore, PhotoScore, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@CF1, @Pkg1, 81.0, 90.0, 78.0, 85.0, 72.0, 80.0, DATEADD(HOUR,-2,@Now), @Now, 0);
...
BEGIN
    INSERT INTO DocumentPackages (Id, AgencyId, State, ActivityState, SubmissionNumber, AssignedCircleHeadUserId, CurrentStep, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@Pkg2, 'A2000002-0000-0000-0000-000000000002', 4, N'Maharashtra', N'FAP-2025-0102', @AsmUserId, 0, DATEADD(HOUR,-2,@Now), @Now, 0);

    INSERT INTO POs (Id, PackageId, PONumber, TotalAmount, RemainingBalance, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@PO2, @Pkg2, N'PO-MH-2025-7802', 1200000.00, 750000.00, N'PO-MH-7802.pdf', N'https://blob/po2.pdf', 310000, N'application/pdf', DATEADD(HOUR,-2,@Now), @Now, 0);
    ...
    INSERT INTO CostSummaries (Id, PackageId, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@CS2, @Pkg2, N'CostSummary-MH-02.pdf', N'https://blob/cs2.pdf', 135000, N'application/pdf', DATEADD(HOUR,-2,@Now), @Now, 0);

    INSERT INTO ActivitySummaries (Id, PackageId, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@AS2, @Pkg2, N'Activity-MH-02.pdf', N'https://blob/as2.pdf', 88000, N'application/pdf', DATEADD(HOUR,-2,@Now), @Now, 0);
    ...
    INSERT INTO ConfidenceScores (Id, PackageId, OverallScore, PoScore, InvoiceScore, CostSummaryScore, ActivityScore, PhotoScore, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@CF2, @Pkg2, 92.0, 95.0, 90.0, 88.0, 93.0, 94.0, DATEADD(HOUR,-1,@Now), @Now, 0);
...
BEGIN
    INSERT INTO DocumentPackages (Id, AgencyId, State, ActivityState, SubmissionNumber, AssignedCircleHeadUserId, CurrentStep, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@Pkg3, 'A3000003-0000-0000-0000-000000000003', 4, N'Karnataka', N'FAP-2025-0103', @AsmUserId, 0, DATEADD(HOUR,-1,@Now), @Now, 0);

    INSERT INTO POs (Id, PackageId, PONumber, TotalAmount, RemainingBalance, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@PO3, @Pkg3, N'PO-KA-2025-1190', 550000.00, 550000.00, N'PO-KA-1190.pdf', N'https://blob/po3.pdf', 200000, N'application/pdf', DATEADD(HOUR,-1,@Now), @Now, 0);

    -- Invoice with some missing fields (Vendor Code missing, GST% missing) to show FAIL checks
    INSERT INTO Invoices (Id, PackageId, POId, VersionNumber, InvoiceNumber, InvoiceDate, VendorName, GSTNumber, SubTotal, TaxAmount, TotalAmount, FileName, BlobUrl, FileSizeBytes, ContentType, ExtractionConfidence, IsFlaggedForReview, ExtractedDataJson, CreatedAt, UpdatedAt, IsDeleted)
    ...
    INSERT INTO CostSummaries (Id, PackageId, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@CS3, @Pkg3, N'CostSummary-KA-03.pdf', N'https://blob/cs3.pdf', 110000, N'application/pdf', DATEADD(HOUR,-1,@Now), @Now, 0);

    INSERT INTO ActivitySummaries (Id, PackageId, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@AS3, @Pkg3, N'Activity-KA-03.pdf', N'https://blob/as3.pdf', 92000, N'application/pdf', DATEADD(HOUR,-1,@Now), @Now, 0);
    ...
    INSERT INTO ConfidenceScores (Id, PackageId, OverallScore, PoScore, InvoiceScore, CostSummaryScore, ActivityScore, PhotoScore, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@CF3, @Pkg3, 68.0, 88.0, 65.0, 60.0, 55.0, 72.0, DATEADD(MINUTE,-30,@Now), @Now, 0);
...
BEGIN
    INSERT INTO DocumentPackages (Id, AgencyId, State, ActivityState, SubmissionNumber, AssignedCircleHeadUserId, CurrentStep, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@Pkg4, 'A1000001-0000-0000-0000-000000000001', 4, N'Gujarat', N'FAP-2025-0104', @AsmUserId, 0, DATEADD(MINUTE,-45,@Now), @Now, 0);

    INSERT INTO POs (Id, PackageId, PONumber, TotalAmount, RemainingBalance, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@PO4, @Pkg4, N'PO-GJ-2025-3350', 650000.00, 420000.00, N'PO-GJ-3350.pdf', N'https://blob/po4.pdf', 230000, N'application/pdf', DATEADD(MINUTE,-45,@Now), @Now, 0);

    -- Invoice with amount exceeding PO balance to show Amount vs PO Balance FAIL
    INSERT INTO Invoices (Id, PackageId, POId, VersionNumber, InvoiceNumber, InvoiceDate, VendorName, GSTNumber, SubTotal, TaxAmount, TotalAmount, FileName, BlobUrl, FileSizeBytes, ContentType, ExtractionConfidence, IsFlaggedForReview, ExtractedDataJson, CreatedAt, UpdatedAt, IsDeleted)
    ...
    INSERT INTO CostSummaries (Id, PackageId, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@CS4, @Pkg4, N'CostSummary-GJ-04.pdf', N'https://blob/cs4.pdf', 125000, N'application/pdf', DATEADD(MINUTE,-45,@Now), @Now, 0);

    INSERT INTO ActivitySummaries (Id, PackageId, FileName, BlobUrl, FileSizeBytes, ContentType, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@AS4, @Pkg4, N'Activity-GJ-04.pdf', N'https://blob/as4.pdf', 98000, N'application/pdf', DATEADD(MINUTE,-45,@Now), @Now, 0);
    ...
    INSERT INTO ConfidenceScores (Id, PackageId, OverallScore, PoScore, InvoiceScore, CostSummaryScore, ActivityScore, PhotoScore, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@CF4, @Pkg4, 75.0, 92.0, 70.0, 80.0, 68.0, 65.0, DATEADD(MINUTE,-20,@Now), @Now, 0);
