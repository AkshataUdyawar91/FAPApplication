...
-- Uses existing AgencyId and SubmittedByUserId from DB
...
DECLARE @SubmittedBy UNIQUEIDENTIFIER = '4AED005F-D377-4929-BC22-CAFB35EA6AE2';
DECLARE @Now DATETIME2 = GETUTCDATE();

-- ============================================================
-- SUBMISSION 1: Pinnacle Advertising - Bihar EV Campaign
-- All checks pass, invoice has all fields
-- ============================================================
...
BEGIN
    INSERT INTO DocumentPackages (Id, AgencyId, SubmittedByUserId, State, ActivityState, SubmissionNumber, AssignedCircleHeadUserId, CurrentStep, VersionNumber, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@Pkg1, @AgencyId, @SubmittedBy, 4, N'Bihar', N'FAP-2025-0101', @AsmUserId, 0, 1, DATEADD(HOUR,-3,@Now), @Now, 0);
    ...
    VALUES (@PO1, @Pkg1, @AgencyId, N'PO-BH-2025-4401', 800000.00, 356279.00, N'PO-BH-4401.pdf', N'https://blob/po1.pdf', 245000, N'application/pdf', 1, DATEADD(HOUR,-3,@Now), @Now, 0);
    ...
    VALUES ('11000001-1111-4000-A000-000000000001', @PO1, 0, 1, 1, 1, 1, 1, 1, 1, DATEADD(HOUR,-2,@Now), @Now, 0);
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000001-1111-4000-A000-000000000002', @CS1, 3, 1, 1, 1, 1, 1, 1, 1, DATEADD(HOUR,-2,@Now), @Now, 0);
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000001-1111-4000-A000-000000000003', @AS1, 4, 1, 1, 1, 1, 1, 1, 1, DATEADD(HOUR,-2,@Now), @Now, 0);
    ...
    VALUES ('22000001-1111-4000-A000-000000000001', @Pkg1, 81.0, 90.0, 78.0, 85.0, 72.0, 80.0, 0, DATEADD(HOUR,-2,@Now), @Now, 0);
...
-- All checks pass, invoice has all fields including VendorCode
-- ============================================================
...
BEGIN
    INSERT INTO DocumentPackages (Id, AgencyId, SubmittedByUserId, State, ActivityState, SubmissionNumber, AssignedCircleHeadUserId, CurrentStep, VersionNumber, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@Pkg2, @AgencyId, @SubmittedBy, 4, N'Maharashtra', N'FAP-2025-0102', @AsmUserId, 0, 1, DATEADD(HOUR,-2,@Now), @Now, 0);

    INSERT INTO POs (Id, PackageId, AgencyId, PONumber, TotalAmount, RemainingBalance, FileName, BlobUrl, FileSizeBytes, ContentType, VersionNumber, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@PO2, @Pkg2, @AgencyId, N'PO-MH-2025-7802', 1200000.00, 750000.00, N'PO-MH-7802.pdf', N'https://blob/po2.pdf', 310000, N'application/pdf', 1, DATEADD(HOUR,-2,@Now), @Now, 0);
    ...
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000002-2222-4000-A000-000000000001', @PO2, 0, 1, 1, 1, 1, 1, 1, 1, DATEADD(HOUR,-1,@Now), @Now, 0);
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000002-2222-4000-A000-000000000002', @CS2, 3, 1, 1, 1, 1, 1, 1, 1, DATEADD(HOUR,-1,@Now), @Now, 0);
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000002-2222-4000-A000-000000000003', @AS2, 4, 1, 1, 1, 1, 1, 1, 1, DATEADD(HOUR,-1,@Now), @Now, 0);

    INSERT INTO ConfidenceScores (Id, PackageId, OverallConfidence, PoConfidence, InvoiceConfidence, CostSummaryConfidence, ActivityConfidence, PhotosConfidence, IsFlaggedForReview, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('22000002-2222-4000-A000-000000000002', @Pkg2, 92.0, 95.0, 90.0, 88.0, 93.0, 94.0, 0, DATEADD(HOUR,-1,@Now), @Now, 0);
...
-- Invoice missing GSTPercentage and VendorCode -> FAIL checks
...
BEGIN
    INSERT INTO DocumentPackages (Id, AgencyId, SubmittedByUserId, State, ActivityState, SubmissionNumber, AssignedCircleHeadUserId, CurrentStep, VersionNumber, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@Pkg3, @AgencyId, @SubmittedBy, 4, N'Karnataka', N'FAP-2025-0103', @AsmUserId, 0, 1, DATEADD(HOUR,-1,@Now), @Now, 0);

    INSERT INTO POs (Id, PackageId, AgencyId, PONumber, TotalAmount, RemainingBalance, FileName, BlobUrl, FileSizeBytes, ContentType, VersionNumber, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@PO3, @Pkg3, @AgencyId, N'PO-KA-2025-1190', 550000.00, 550000.00, N'PO-KA-1190.pdf', N'https://blob/po3.pdf', 200000, N'application/pdf', 1, DATEADD(HOUR,-1,@Now), @Now, 0);
    ...
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000003-3333-4000-A000-000000000001', @PO3, 0, 1, 1, 1, 1, 1, 1, 1, DATEADD(MINUTE,-30,@Now), @Now, 0);
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000003-3333-4000-A000-000000000002', @CS3, 3, 0, 1, 1, 1, 1, 0, 1, DATEADD(MINUTE,-30,@Now), @Now, 0);
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000003-3333-4000-A000-000000000003', @AS3, 4, 0, 1, 1, 1, 1, 1, 0, DATEADD(MINUTE,-30,@Now), @Now, 0);

    INSERT INTO ConfidenceScores (Id, PackageId, OverallConfidence, PoConfidence, InvoiceConfidence, CostSummaryConfidence, ActivityConfidence, PhotosConfidence, IsFlaggedForReview, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('22000003-3333-4000-A000-000000000003', @Pkg3, 68.0, 88.0, 65.0, 60.0, 55.0, 72.0, 1, DATEADD(MINUTE,-30,@Now), @Now, 0);
...
BEGIN
    INSERT INTO DocumentPackages (Id, AgencyId, SubmittedByUserId, State, ActivityState, SubmissionNumber, AssignedCircleHeadUserId, CurrentStep, VersionNumber, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@Pkg4, @AgencyId, @SubmittedBy, 4, N'Gujarat', N'FAP-2025-0104', @AsmUserId, 0, 1, DATEADD(MINUTE,-45,@Now), @Now, 0);

    INSERT INTO POs (Id, PackageId, AgencyId, PONumber, TotalAmount, RemainingBalance, FileName, BlobUrl, FileSizeBytes, ContentType, VersionNumber, CreatedAt, UpdatedAt, IsDeleted)
    VALUES (@PO4, @Pkg4, @AgencyId, N'PO-GJ-2025-3350', 650000.00, 420000.00, N'PO-GJ-3350.pdf', N'https://blob/po4.pdf', 230000, N'application/pdf', 1, DATEADD(MINUTE,-45,@Now), @Now, 0);
    ...
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000004-4444-4000-A000-000000000001', @PO4, 0, 1, 1, 1, 1, 1, 1, 1, DATEADD(MINUTE,-20,@Now), @Now, 0);
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000004-4444-4000-A000-000000000002', @CS4, 3, 1, 1, 1, 1, 1, 1, 1, DATEADD(MINUTE,-20,@Now), @Now, 0);
    INSERT INTO ValidationResults (Id, DocumentId, DocumentType, AllValidationsPassed, SapVerificationPassed, AmountConsistencyPassed, LineItemMatchingPassed, CompletenessCheckPassed, DateValidationPassed, VendorMatchingPassed, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('11000004-4444-4000-A000-000000000003', @AS4, 4, 1, 1, 1, 1, 1, 1, 1, DATEADD(MINUTE,-20,@Now), @Now, 0);

    INSERT INTO ConfidenceScores (Id, PackageId, OverallConfidence, PoConfidence, InvoiceConfidence, CostSummaryConfidence, ActivityConfidence, PhotosConfidence, IsFlaggedForReview, CreatedAt, UpdatedAt, IsDeleted)
    VALUES ('22000004-4444-4000-A000-000000000004', @Pkg4, 75.0, 92.0, 70.0, 80.0, 68.0, 65.0, 0, DATEADD(MINUTE,-20,@Now), @Now, 0);
...
SELECT COUNT(*) AS TotalPendingASM FROM DocumentPackages WHERE State = 4 AND IsDeleted = 0;
