...
public class AnalyticsEmbeddingPipeline : IAnalyticsEmbeddingPipeline
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var stateGroup in stateGroups)
        {
            ...
            var rejectedCount = statePackages.Count(p => p.State == PackageState.CHRejected || p.State == PackageState.RARejected);
        ...
        var allRejectedCount = packages.Count(p => p.State == PackageState.CHRejected || p.State == PackageState.RARejected);
