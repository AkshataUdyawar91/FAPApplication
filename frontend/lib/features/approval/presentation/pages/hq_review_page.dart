...
class _HQReviewPageState extends State<HQReviewPage> {
        ...
        child: Container(
          ...
          child: Column(children: [
            Container(
              ...
              child: Row(children: [
                _headerCell('FAP NUMBER', 140), _headerCell('PO NO.', 120), _headerCell('PO AMT', 140),
                _headerCell('INVOICE NO.', 160), _headerCell('INVOICE AMT', 140), _headerCell('SUBMITTED DATE', 140),
                _headerCell('AI SCORE', 100), _headerCell('STATUS', 140), const SizedBox(width: 80),
              ]),
            ),
  ...
  Widget _headerCell(String text, double width) {
    return SizedBox(width: width, child: Text(text, style: AppTextStyles.bodySmall.copyWith(fontWeight: FontWeight.w600, color: AppColors.textSecondary)));
  }
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        SizedBox(width: 80, child: IconButton(
          ...
          onPressed: () => _navigateToDetail(doc['id']), tooltip: 'View Details',
        )),
      ]),
    );
  }
